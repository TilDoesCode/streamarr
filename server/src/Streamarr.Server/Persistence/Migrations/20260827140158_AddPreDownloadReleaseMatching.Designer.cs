...
namespace Streamarr.Server.Persistence.Migrations
{
    ...
    [Migration("20260827140158_AddPreDownloadReleaseMatching")]
    partial class AddPreDownloadReleaseMatching
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Streamarr.Server.Persistence.Entities.GeneralConfigEntity", b =>
                {
                    ...
                    b.Property<int>("EphemeralCacheSizeMb")
                        .HasColumnType("INTEGER");

                    b.Property<int>("IndexerResultLimit")
                        .HasColumnType("INTEGER");
