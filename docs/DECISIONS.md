...
| 2 | **Jellyfin target version** | **Jellyfin 10.11.11.** The plugin is ABI-pinned and host-load tested against this exact release; re-test and update `docs/jellyfin-compatibility.md` before changing it. |
